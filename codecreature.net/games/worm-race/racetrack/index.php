...
<html lang="en">
	<head>
		...
		<!-- svg icons -->
		<link href="/graphix/svg-icons/svg-icons-new.css?fileversion=20260915" rel="stylesheet" type="text/css"></link>
		
		<!--base stylesheet-->
		<link href="/style.css?fileversion=20260915" rel="stylesheet" type="text/css" media="all">
		<!--worms common stylesheet-->
		<link href="/games/worm-common/style.css?fileversion=20260915" rel="stylesheet" type="text/css" media="all">
		<!--worm race game stylesheet-->
		<link href="../style.css?fileversion=20260915" rel="stylesheet" type="text/css" media="all">
		<!--this page's stylesheet-->
		<link href="racetrack.css?fileversion=20260915" rel="stylesheet" type="text/css" media="all">
