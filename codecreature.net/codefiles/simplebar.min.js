 ...
 * Under MIT License
 */
if (localStorage.getItem("customScrollbarsOn") == null || localStorage.getItem("customScrollbarsOn") == "true") {
	customScrollbarsOn = true;
	
	// add the style sheet to the document that loaded this
	let css = document.createElement('link');
	css.rel = 'stylesheet';
	css.type = 'text/css';
	css.href = '/codefiles/simplebar.css';
