...
<html lang="en"><head>
    ...
    <title><?php echo $chatroom_name; ?> chat</title>
		...
		<!-- page settings -->
		<script src="/codefiles/page-settings.min.js?fileversion=20260725"></script>
		<!-- typing quirk alt text -->
		<script src="/codefiles/typing-quirks.min.js?fileversion=20260725"></script>
		
		<!-- fonts -->
		<script>fonts.load('Yet R','Super Comic')</script>
		
		<!-- svg icons -->
		<script src="/graphix/svg-icons/svg-icons.js?fileversion=20260725" id="svg-icons-js"></script>
		
		<!--base stylesheet-->
		<link href="/style.css?fileversion=20260725" rel="stylesheet" type="text/css" media="all">
		<!--bbcode stylesheet-->
		<link href="/chat/bbcode.css?fileversion=20260725" rel="stylesheet" type="text/css" media="all">
		<!--chat stylesheet-->
		<link href="/chat/chat.css?fileversion=20260725" rel="stylesheet" type="text/css" media="all">
