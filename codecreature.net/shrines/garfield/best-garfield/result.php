...
<html lang="en">
	<head>
		...
		<script src="/codefiles/required.js?fileversion=20260719"></script>
		<!-- universal base css -->
		<link href="/codefiles/required.css?fileversion=20260719" rel="stylesheet" type="text/css"></link>
		
		<script>fonts.load('Garfield','Ad Lib')</script>
		
		<!-- svg icons -->
		<script src="/graphix/svg-icons/svg-icons.js?fileversion=20260719" id="svg-icons-js"></script>
		<!-- page settings -->
		<script src="/codefiles/page-settings.min.js?fileversion=20260719"></script>
		<!-- typing quirk alt text -->
		<script src="/codefiles/typing-quirks.min.js?fileversion=20260719"></script>
		
		<!--this page's stylesheet-->
		<link href="/shrines/garfield/style.css?fileversion=20260719" rel="stylesheet" type="text/css" media="all">
		<link href="/shrines/garfield/best-garfield/style.css?fileversion=20260719" rel="stylesheet" type="text/css" media="all">
		<link href="/shrines/garfield/best-garfield/result.css?fileversion=20260719" rel="stylesheet" type="text/css" media="all">
