...
<html lang="en">
	<head>
		...
		<!-- load jQuery -->
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js?fileversion=20260705"></script>
		<!-- load navigation -->
		...
		<link href="/shrines/garfield/best-garfield/poll.css?fileversion=20260705" rel="stylesheet" type="text/css" media="all">
	</head>
